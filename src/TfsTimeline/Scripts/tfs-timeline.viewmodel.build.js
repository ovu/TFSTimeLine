...
tfsTimeline.BuildsViewModel = function (serviceUrl) {
    ...
    self.createBuildViewModel = function (build) {
        ...
        buildViewModel.runDurationMinutes = ko.computed(function () {
            ...
            return tfsTimeline.formatDurationShortTime(duration);
        });
        ...
        // Formats the time that the build has been started at as 9-November
        buildViewModel.startedAtDate = ko.computed(function () {
            var startedAt = tfsTimeline.parseJsonDate(buildViewModel.StartedAt());
            return tfsTimeline.formatShortDate(startedAt);
        });
